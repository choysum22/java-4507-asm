...
public class RemoteControlCarFactory implements ToyFactory {
    ...
    public ToyProduct createToy(Scanner sc, LinkedList toys) {
        ...
        while (true) {
            try {
                ...
                // enter max speed of the toy
                System.out.println("Enter max speed(km/hr):");
                maxSpeed = Double.parseDouble(sc.nextLine());
                break;
